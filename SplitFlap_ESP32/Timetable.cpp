...
TimetableEntry weekdayTimetable[] = {
  {"Blank", 5, 8, 0, 0},
...
TimetableEntry weekendTimetable[] = {
  {"Blank", 5, 8, 0, 0},
  {"L-Haibara", 5, 38, 31, 39}, // Actual end is Yamato-Asakura
...
const int WEEKDAY_TIMETABLE_LENGTH = sizeof(weekdayTimetable) / sizeof(weekdayTimetable[0]);
const int WEEKEND_TIMETABLE_LENGTH = sizeof(weekendTimetable) / sizeof(weekendTimetable[0]);